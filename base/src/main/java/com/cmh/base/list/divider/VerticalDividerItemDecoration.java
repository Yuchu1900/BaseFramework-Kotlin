...
/**
 * Created by kexuejin on 2017/2/10.
 */
...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    protected Rect getDividerBound(int position, RecyclerView parent, View child) {
        ...
        bounds.top = (int) child.getY() + child.getPaddingTop() +
                mMarginProvider.dividerTopMargin(position, parent) + transitionY;
        bounds.bottom = (int) child.getY() + child.getHeight() - parent.getPaddingBottom() -
